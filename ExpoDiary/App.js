...
function Login({ setScreen }) {
  ...
  return (
    <ImageBackground source={require('./assets/chaeeun2.png')} style={styles.backgroundImage}>
    <View style={styles.outer}>
      <View style={styles.inner}>
...
export default function App() {
  ...
  const getScreen = () => {
    if (loggedIn) {
      // Render the main navigation container when logged in
      return (
        <NavigationContainer>
    ...
    // Render authentication screens when not logged in
